...
query_rewrite_examples = [
    EvaluationExample(
        ...
        grading_context={"ground_truth": "What did Dan Rather say about the incident where he was attacked?"},
        score=2,
        justification="The rewritten query miss the key information about the person involved in the incident (Dan Rather). and also the context of the incident is not clear enough. "
    ),
    EvaluationExample(
        output="Who else did Paul Rudd co star with besides Jason Segel?",
        grading_context={"ground_truth": "Who else did Paul Rudd co-star with aside from Jason Segel in the movie"},
        score=5,
        justification="The rewritten query is clear and concise, preserving the original query's intent. "
    )
]
