...
const markdownComponents: Components = {
  ...
  h2: (props) => (
    <h2 className="mt-6 scroll-m-20 text-xl font-heading font-semibold tracking-tight" {...props} />
  ),
  h3: (props) => (
    <h3 className="mt-5 scroll-m-20 text-lg font-heading font-semibold tracking-tight" {...props} />
  ),
  h4: (props) => (
    <h4 className="mt-4 scroll-m-20 text-base font-heading font-semibold tracking-tight" {...props} />
  ),
  p: (props) => <p className="leading-7 [&:not(:first-child)]:mt-4 text-base" {...props} />,
