  ...
  return (
    <ChatProvider initialChatId={chatId}>
      ...
      >
        {
          !hideContextBoard && (
            <div className="absolute top-0 inset-x-0 p-4 backdrop-blur bg-background supports-[backdrop-filter]:bg-background/50">
              <ContextBoard
        ...
        {
          chatId && (
            <ScrollArea className='w-full h-full p-4 pt-16'>
