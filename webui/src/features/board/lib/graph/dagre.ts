...
import type { LayoutAlgorithm } from './settings'
...
/**
 * Dagre layout algorithm for arranging nodes in a graph.
 */
export const dagreLayout: LayoutAlgorithm = async (nodes: NoteNode[], edges: LinkEdge[], options) => {
  dagreGraph.setGraph({
